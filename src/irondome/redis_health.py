...
logger = logging.getLogger("irondome.redis")
...
class RedisConfig:
    ...
    def from_env(cls) -> RedisConfig:
        ...
        Env vars:
          IRONDOME_REDIS_URL — Redis URL (required for Redis mode)
          IRONDOME_REDIS_ENABLED — 'true' or 'false' (optional, auto-detect if unset)
          IRONDOME_REDIS_TIMEOUT — socket timeout in seconds (optional)
        """
        url = os.environ.get("IRONDOME_REDIS_URL", "")
        enabled_str = os.environ.get("IRONDOME_REDIS_ENABLED", "")
        timeout_str = os.environ.get("IRONDOME_REDIS_TIMEOUT", "")
