...
logger = logging.getLogger("irondome.tenant")
...
def load_tenants_from_env() -> TenantRegistry:
    ...
    Format:
      IRONDOME_TENANTS=team1:Team One;team2:Team Two
      IRONDOME_TENANT_TOKEN_MAP=<token_hash>:<tenant_id>,...
    ...
    # Load tenants
    tenants_str = os.environ.get("IRONDOME_TENANTS", "")
    if tenants_str:
