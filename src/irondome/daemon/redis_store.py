...
Configuration:
  IRONDOME_REDIS_URL — Redis connection URL (default: redis://localhost:6379/0)
...
logger = logging.getLogger("irondome.daemon.redis_store")
...
class RedisScanJobStore:
    ...
    Stores each job as a Redis hash under ``irondome:job:<job_id>``.
    ...
    def __init__(
        ...
        self._redis_url = redis_url or os.environ.get("IRONDOME_REDIS_URL", _DEFAULT_REDIS_URL)
