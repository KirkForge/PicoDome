...
class SubprocessBackend(SandboxBackend):
    ...
    def _check_suspicious_patterns(
        ...
        patterns = [
            ...
            (r'(?i)(subprocess|os\.system|os\.popen|commands\.getoutput)', "L3-SUS-002", "shell_execution", Verdict.DENY),
            ...
            (r'(?i)(base64\s.*decode|base64\s-d)', "L3-SUS-006", "base64_decoding", Verdict.DENY),
            ...
            (r'(?i)(/root/|/home/\w+/\.)', "L3-SUS-010", "dotfile_access", Verdict.DENY),
        ]
