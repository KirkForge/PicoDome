...
def _cmd_sandbox(args) -> int:
    ...
    # Resolve backend
    from picodome.l3.engine import BackendUnavailableError, _detect_backend
...
def _cmd_analyze(args) -> int:
    ...
    from picodome.l3.models import SandboxEvent, Verdict
...
def _cmd_daemon(args) -> int:
    ...
    if transport == "grpc":
        from picodome.grpc_transport import PicoDomeGRPCServer, is_grpc_available
        ...
        # HTTP daemon (default)
        from picodome.daemon import PicoDomeDaemon
...
def _cmd_health(args) -> int:
    """Run health checks."""
    from picodome.health import check_health
...
def _cmd_audit(args) -> int:
    """Query the audit log."""
    from picodome.audit import AuditEventType, get_audit_logger
...
def _cmd_retention(args) -> int:
    ...
    from picodome.retention import get_retention_manager
...
def _cmd_policy_versions(args) -> int:
    ...
    from picodome.policy_versioned import get_policy_store
...
def _cmd_notary(args) -> int:
    ...
    from picodome.notary import AuditNotary, NullNotary, RekorNotary, sign_entry
...
def _cmd_cluster(args) -> int:
    ...
    if action == "join":
        ...
        try:
            from picodome.cluster.manager import _cluster_manager
