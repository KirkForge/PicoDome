...
from picodome.l3.engine import SandboxEngine, sandbox_run
from picodome.l3.models import Policy, PolicyRule, RuleTarget, SyscallAction, Verdict
...
class TestBackendDetection:
    ...
    def test_detect_seccomp_degrades_to_subprocess(self):
        ...
        with patch("picodome.l3.engine.platform.system", return_value="FreeBSD"):
...
class TestSandboxEngineExtra:
    def test_engine_with_explicit_backend(self):
        from picodome.l3.backends.subprocess_backend import SubprocessBackend
        from picodome.l3.engine import SandboxEngine
...
class TestGetSetBackend:
    def test_set_and_reset_backend(self):
        from picodome.l3.backends.subprocess_backend import SubprocessBackend
        from picodome.l3.engine import get_backend, reset_backend, set_backend
    ...
    def test_backend_unavailable_error(self):
        from picodome.l3.engine import BackendUnavailableError
